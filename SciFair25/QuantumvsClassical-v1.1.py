...
db_sizes = [4, 8, 16, 32]
quantum_times = [0.02, 0.03, 0.05, 0.07]
classical_times = [0.001, 0.003, 0.006, 0.015]

plt.plot(db_sizes, quantum_times, label="Quantum")
plt.plot(db_sizes, classical_times, label="Classical")
plt.xlabel("DB Size")
plt.ylabel("Time")
plt.legend()
plt.show()
